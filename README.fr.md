...
| [Solveur 3-SAT sur GF(2)](Groebner_Basis_SAT_Solver/) | Les clauses deviennent des polynômes ; une élimination triangulaire à la Gröbner propage, le branchement termine. Vérifié contre une recherche exhaustive sur 2 500 instances. *Python* |
...
Le README de chaque dossier indique quoi lancer depuis là. Les scripts Blender se
chargent plutôt dans l'espace de travail Scripting de Blender.
