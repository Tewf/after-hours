...
|---|---|
| [Flappy Bird à partir des pixels bruts](Flappy_Bird_CNN/) | REINFORCE avec une baseline de valeur, et un DQN pour comparaison. Les deux apprennent sur quatre images 84×84 empilées et ne voient jamais l'état du jeu. *PyTorch, Pygame, Gymnasium* |
...
| [L'impôt français, modélisé](Taxes/) | Ajustements exponentiels par tranche, puis la fonction W de Lambert pour trouver le point de bascule, à 62 114 € brut. *SciPy, Quarto* |
| [Algorithmes de tri en 3D](Blender_Python_Scripts/) | Tri à bulles et tri fusion animés et rendus via l'API Python de Blender. *Blender* |
