...
| Project | What it is |
|---|---|
| [Flappy Bird from raw pixels](Flappy_Bird_CNN/) | A convolutional policy network trained by REINFORCE on 84×84 frames, with no access to game state. *PyTorch, Pygame, Gymnasium* |
...
| [French income tax, modelled](Taxes/) | Exponential fits per bracket, then Lambert W to find the tipping point — €62,114 gross. *SciPy, Quarto* |
| [Sorting algorithms in 3D](Blender_Python_Scripts/) | Bubble and merge sort animated through Blender's Python API. *Blender* |
